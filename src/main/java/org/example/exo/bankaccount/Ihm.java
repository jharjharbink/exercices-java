package org.example.exo.bankaccount;
...
import org.example.exo.bankaccount.exceptions.ReturnToMainLoop;
import org.example.exo.bankaccount.metier.bankAccounts.AccountType;
import org.example.exo.bankaccount.metier.bankAccounts.BankAccount;

import static org.example.exo.bankaccount.metier.StatusOperation.*;
import static org.example.exo.bankaccount.Menus.*;
import static org.example.exo.bankaccount.metier.bankAccounts.AccountType.*;
...
public class Ihm {
    ...
    private void operationCreationTunnel(StatusOperation operationStatus) throws Exception {
    ...
    public void performOperation(StatusOperation operationStatus, BankAccount bankAccount) throws Exception {
    ...
    private String getOperationTypeString(StatusOperation operationStatus){  // TODO put this method in Enum
